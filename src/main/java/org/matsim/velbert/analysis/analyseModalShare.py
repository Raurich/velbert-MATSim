...
csv_name = "velbert-v1.0-1pct.output_trips.csv"
path_to_txt = "../../../../../resources/personIdsFromVelbert.txt"
...
fig, ax = plt.subplots()
desired = ax.bar(x - width / 2, list_desired, width, label="Desired")
actual = ax.bar(x + width / 2, list_actual, width, label="Actual")
